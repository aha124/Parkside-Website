...
export default function AboutPage() {
  ...
  const chorusContent = {
    harmony: {
      ...
      description: "Parkside Harmony is an award-winning men's barbershop chorus, consistently ranked among the top choruses in the Mid-Atlantic District.",
      storyIntro: "Parkside Harmony has grown from a small group of passionate singers into one of the premier men's barbershop choruses in the Mid-Atlantic region.",
      ...
      joinCTA: "Experience the thrill of men's barbershop at its finest.",
    },
    melody: {
      name: "Parkside Melody",
      tagline: "Celebrating women's barbershop harmony since 2018",
      description: "Parkside Melody is a vibrant women's barbershop chorus dedicated to musical excellence and sisterhood.",
      storyIntro: "Parkside Melody was born from a shared love of harmony singing and a desire to create a welcoming space for women to experience the joy of barbershop.",
      ...
      joinCTA: "Discover the power of women's voices in harmony.",
    },
    voices: {
      name: "Parkside",
      tagline: "Celebrating barbershop excellence in Hershey since 2015",
