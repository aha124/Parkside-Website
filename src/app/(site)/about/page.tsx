...
export default function AboutPage() {
  ...
  const chorusContent = {
    harmony: {
      ...
      description: "Parkside Harmony is an award-winning bass clef barbershop chorus, consistently ranked among the top choruses in the Mid-Atlantic District.",
      storyIntro: "Parkside Harmony has grown from a small group of passionate singers into one of the premier bass clef barbershop choruses in the Mid-Atlantic region.",
      ...
      joinCTA: "Experience the thrill of bass clef barbershop at its finest.",
    },
    melody: {
      name: "Parkside Melody",
      tagline: "Celebrating treble clef barbershop harmony since 2018",
      description: "Parkside Melody is a vibrant treble clef barbershop chorus dedicated to musical excellence and community.",
      ...
      joinCTA: "Discover the power of treble voices in harmony.",
    },
    voices: {
      name: "Parkside",
      tagline: "Celebrating barbershop excellence in Hershey since 2015",
