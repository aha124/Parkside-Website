...
interface SplashTabProps {
  ...
  onImageSelect: (type: "splash", chorus: ChorusKey) => void;
}

export default function SplashTab({ settings, onImageSelect }: SplashTabProps) {
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-lg font-semibold text-gray-900">Splash Page Backgrounds</h2>
        <p className="text-sm text-gray-500">
          Background images for the landing/splash page carousel (mobile) and desktop split view.
        </p>
      </div>
